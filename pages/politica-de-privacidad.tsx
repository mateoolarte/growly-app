...
export default function Privacy() {
  return (
    <Layout
      ...
      description="La presente Política de Privacidad establece los términos en que Growly usa y protege la información que es proporcionada por sus usuarios al momento de utilizar su sitio web."
      hideCookies
    >
      <Wrapper>
        ...
        <p>
          ...
          Growly usa y protege la información que es proporcionada por sus
        ...
        <p>
          ...
          proporcione y podrán ser cancelados en cualquier momento. Growly está
        ...
        <p>
          ...
          servicio de los sitios web, estas no dan acceso a información de su
        ...
        <p>
          ...
          de la información personal que es proporcionada en nuestro sitio web:
          www.getgrowly.com. Cada vez que se le solicite rellenar un formulario,
          ...
          cancelarla en cualquier momento. Growly no venderá, cederá ni
          ...
          judicial. Growly se reserva el derecho de cambiar los términos de la
